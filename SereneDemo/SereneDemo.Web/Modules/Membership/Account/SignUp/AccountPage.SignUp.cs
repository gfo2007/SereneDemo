...
using SereneDemo.Administration;
using SereneDemo.Administration.Entities;
using SereneDemo.Administration.Repositories;
using SereneDemo.Common;
using Serenity;
using Serenity.Data;
...
namespace SereneDemo.Membership.Pages
{
